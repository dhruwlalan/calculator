<template>
	<div>
		<div class="settings" @click="showModal" v-show="devMode">
		...
		<transition name="modal-fade" @enter="showInnerModal = true">
			<div class="modal" v-show="modal" @click.self="exitModal">
				<transition name="modal-zoom">
					<div class="modal__box" v-show="showInnerModal">
...
<script>
	export default {
		props: ['design' , 'theme' , 'modal' , 'devMode'] ,
		data () {
			return {
